...
## The game will have:
1. There will be 4 sides D
2. Each side will start the game with the same ammount of money D
3. There will be 5 types of unit D
4. The unit will be selected randomly every 1 secconds for 10 seconds
5. If the side has enough money they can get that unit if not they have to wait 1 seconds to get another chance D
